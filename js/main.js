...
var viewportH,viewportW;// canvas
...
ctx.translate(lastTransformState.translate[0],lastTransformState.translate[1]);ctx.scale(lastTransformState.scale,lastTransformState.scale);while(++i<n){d=drawdat.draw[i];cx=d[0][0];cy=d[0][1];ctx.fillStyle=//fc = 
